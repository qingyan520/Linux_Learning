...
void*Run(void*arg)
{
    ...
    while(1)
    {
        ...
        cout<<"thread:"<<pthread_self()<<"活动....."<<endl;
...
int main()
{
    pthread_mutex_inti(&lock,nullptr);
    pthread_cond_init(&cond,nullptr);
    pthread_t ctrl,t1,t2,t3;
    //pthread_create(&ctrl,nullptr,CtrlRoutinue,nullptr);
    pthread_create(&t1,nullptr,Run,"thread 1");
    pthread_create(&t2,nullptr,Run,"thread 2");
    pthread_create(&t3,nullptr,Run,"thread 3");
    
    while(true)
    {
        getchar();
        //pthread_cond_signal(&cond);
        pthread_broadcast(&cond);//唤醒全部线程
    }
